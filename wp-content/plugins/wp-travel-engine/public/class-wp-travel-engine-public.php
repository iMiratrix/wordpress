...
class Wp_Travel_Engine_Public {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js' . $asset_script_path . 'wp-travel-engine-main' . $version_prefix . '.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'jquery-steps', 'jquery-validate', 'all', 'v4-shims', 'toastr', 'jquery-sticky-kit', 'parsley', 'magnific-popup', 'owl-carousel', 'wte-rrule' ), $this->version, true );
		...
		wp_register_script( 'wte-rrule', plugin_dir_url( __FILE__ ) . 'js/lib/rrule.min.js', array( 'jquery' ), '3.3.2', true );
